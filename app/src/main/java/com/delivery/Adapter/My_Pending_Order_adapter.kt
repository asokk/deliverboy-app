...
class My_Pending_Order_adapter : RecyclerView.Adapter<My_Pending_Order_adapter.MyViewHolder> {
    private var modelList: List<My_Pending_order_model>
    private var inflater: LayoutInflater? = null
    private var currentFragment: Fragment? = null
    private var context: Context? = null

    constructor(context: Context, modemodelList: List<My_Pending_order_model>, currentFragment: Fragment?) {
    ...
    constructor(modelList: List<My_Pending_order_model>) {
